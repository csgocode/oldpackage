...
def downloadsocks(choice):
    ...
    if choice == "4":
        f = open(out_file, 'wb')
        try:
            r = requests.get("http://77.68.116.208/privateapi/socks4premium.txt", timeout=5)
            f.write(r.content)
            f.close()
        except:
            f.close()
    if choice == "5":
        ...
        try:
            r = requests.get(
                "http://77.68.116.208/privateapi/socks5premium.txt",
                timeout=5)
            f.write(r.content)
            f.close()
        except:
    ...
    if choice == "1":
        f = open(out_file, 'wb')
        try:
            r = requests.get("http://77.68.116.208/privateapi/premiumhttp.txt", timeout=5)
            f.write(r.content)
            f.close()
        except:
            f.close()
